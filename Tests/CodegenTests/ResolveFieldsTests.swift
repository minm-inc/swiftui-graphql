...
//            "Foo": OldResolvedField.Object(
//                type: schema.getType(name: "Foo")! as! GraphQLOutputType,
//                unconditional: [
//                    "e": .nested(OldResolvedField.Object(
...
//        
//        XCTAssertEqual(object.conditional["X"], OldResolvedField.Object(
//            type: schema.getType(name: "X")! as! GraphQLOutputType,
//            unconditional: [
//                "x1": .leaf(GraphQLInt),
//                "x2": .nested(OldResolvedField.Object(
...
//            ]
//        ))
//        XCTAssertEqual(object.conditional["Y"], OldResolvedField.Object(
...
//            [
//                "a": .nested(OldResolvedField.Object(
...
//                    fragProtos: [:]
//                )),
//                "b": .nested(OldResolvedField.Object(
//                    type: schema.getType(name: "A")! as! GraphQLObjectType,
//                    unconditional: [
//                        "b1": .leaf(GraphQLInt)
//                    ],
...
//            fragments: fragments
//        )
//        XCTAssertEqual(object.unconditional["a"], .nested(OldResolvedField.Object(
...
//}
//
//extension OldResolvedField: Equatable {
//    public static func == (lhs: OldResolvedField, rhs: OldResolvedField) -> Bool {
//        switch (lhs, rhs) {
...
//}
//
//extension OldResolvedField.Object: Equatable {
//    public static func == (lhs: OldResolvedField.Object, rhs: OldResolvedField.Object) -> Bool {
