...
struct Codegen: AsyncParsableCommand {
    ...
    mutating func run() async throws {
        ...
        do {
            document = attachCachableFields(schema: schema, document: try GraphQL.parse(source: source))
        ...
        generated.buildSyntax(format: Format(), leadingTrivia: .zero).write(to: &output)
    }
